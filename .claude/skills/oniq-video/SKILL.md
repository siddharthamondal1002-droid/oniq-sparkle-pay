...
- Both live clips are static uploads in Lovable's asset store
  ...
  matches the Remotion renderer's output name.
  `lores-firefly-forest.mp4` was **generated by Lovable's own agent from ONIQ
  app images** (confirmed by the project owner, 2026-08-08) — AI-generated,
  from inputs ONIQ owns, and produced entirely outside this repo.
