// Render ONIQ Originals Episode 2 to mp4, narration included.
//
...
const OUT = process.env.OUT ?? path.resolve(__dirname, '../../.tmp/ep2.mp4');
...
console.log(`ep2: ${composition.durationInFrames} frames @ ${composition.fps}fps -> ${OUT}`);
