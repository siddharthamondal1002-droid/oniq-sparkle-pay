...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Replicates screenshots into functional web applications with pixel-perfect accuracy." },
      { property: "og:description", content: "Replicates screenshots into functional web applications with pixel-perfect accuracy." },
      { name: "twitter:description", content: "Replicates screenshots into functional web applications with pixel-perfect accuracy." },
