 ...
 * public.video_jobs is the admin-only Runway render queue and
 * public.episode_jobs is the admin-only episode render queue — "jobs" as in
 * background tasks. Both are admin-gated by RLS and carry nothing about a
