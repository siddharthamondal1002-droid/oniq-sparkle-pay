...
export type AiSurface =
  ...
  | "music_ai_output"
  /** Create — Image. The whole picture is generated, from the person's own sentence. */
  | "image_ai_output"
  /** Create — Voice. A synthetic voice reading the person's own words. */
  | "voice_ai_output"
  /** Create — My Creations. Every item on it was generated by ONIQ. */
  | "creations_ai_output"
  /** ONIQ Health — AI-read records, suggested records and the gateway's answers (Phase 2, dark). */
  | "health_ai_output";
