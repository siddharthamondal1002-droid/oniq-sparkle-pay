 ...
 */
import { type Amplitude, cNorm2 } from "./math/complex.ts";
import { type Unitary2, mixing, relativePhase, rotation } from "./math/unitary.ts";
import type { QuantumOperator } from "./operators.ts";
import { type CognitiveState, type TransitionOptions } from "./formalState.ts";
