-- Earn: villages, partner verification docs, region activation (20 partners),
-- and free service bookings.

-- ---------- partner_applications: village/region + verification ----------
...
-- ---------- region status: services unlock at 20 registered partners ----------
...
-- Providers listed only once a region is live; no phone/PII beyond name.
...
-- Inserts/updates go through the RPCs below only.

-- Book a partner. Bookings are FREE — ONIQ charges nothing; no wallet rows
-- are touched here by design.
...
-- Incoming booking requests for the signed-in partner.
...
-- Partner accepts/declines a request; customer can cancel their own.
